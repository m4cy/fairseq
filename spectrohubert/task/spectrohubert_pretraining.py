...
@dataclass
class SpectroHubertPretrainingConfig(HubertPretrainingConfig):  
    stats_npz_path: str = field(default="", metadata={"help": "path to the mean and variance of all fbank features."})
    
@register_task("spectrohubert_pretraining", dataclass=SpectroHubertPretrainingConfig)  
class SpectroHubertPretrainingTask(HubertPretrainingTask):  

    cfg: SpectroHubertPretrainingConfig
    ...
    @classmethod
    def setup_task(
        cls, cfg: SpectroHubertPretrainingConfig, **kwargs
